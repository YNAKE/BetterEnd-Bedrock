...
const DestroyComponent = {
    onPlayerDestroy(e) {
        ...
        if (fenceSet.has(blockBelow.typeId)) {
            block.setPermutation(BlockPermutation.resolve("betterend:white_oak_fence_inventory", { "betterend:post": 1 }));
        }
...
export { applyDurabilityDamage, getRelevantEnchantments, isSlab, fenceSet, fenceMap, leafSet, leafDropMap, saplingBlocks, logSet, sapSet, logMap, trapSet, fruitSet };
