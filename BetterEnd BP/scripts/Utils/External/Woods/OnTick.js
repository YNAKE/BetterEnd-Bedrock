...
export const OnTickComponent = {
    onTick(e) {
        ...
        const excludeBlocksArray = [
            ...
            "betterend:white_oak_fence_inventory",
            "betterend:orange_tree_fence_inventory",
            "mc:leshy_door",
        ...
        block.setPermutation(block.permutation.withState("betterend:north_picket", northConnects ? 1 : 0));
        block.setPermutation(block.permutation.withState("betterend:south_picket", southConnects ? 1 : 0));
        block.setPermutation(block.permutation.withState("betterend:east_picket", eastConnects ? 1 : 0));
        block.setPermutation(block.permutation.withState("betterend:west_picket", westConnects ? 1 : 0));
    },
};
...
function handleSaplingGrowth(block, dimension) {
    ...
    if (num > data.growChance.numerator)
        return;
